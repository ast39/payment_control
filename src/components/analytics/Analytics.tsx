  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Общая статистика за {new Date().getFullYear()} год</h3>
                ...
                >
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    <div className="flex justify-between text-sm text-gray-500">
                      ...
                      <span>{new Intl.NumberFormat('ru-RU').format(Math.round(totalAmount / 12))}</span>
                    </div>
                    <div className="flex justify-between text-sm text-gray-500">
                      <span>Максимум в месяц:</span>
                      <span>{new Intl.NumberFormat('ru-RU').format(Math.max(...dataset.data))}</span>
                    </div>
                  </div>
                </div>
              );
